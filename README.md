...
3. Select your Utility Provider:
   - **AutoSalubritate** (In Progress)
   - **Premier Energy** (Planned)
   - **Chișinău-Gaz** (Planned)
   - **InfoSarp** (Planned)
4. Fill in your Contract / Place of Consumption Number and login credentials.
5. Click **Submit**.
